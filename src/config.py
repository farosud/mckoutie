...
class Settings(BaseSettings):
    ...
    persona_model: str = "claude-haiku-4-5-20251001"  # Haiku on VPS (proxy routes to whatever model it has)
    persona_model_fallback: str = "anthropic/claude-haiku-4.5"  # Haiku on OpenRouter fallback
    persona_model_fallback2: str = "google/gemini-2.5-flash"  # Gemini Flash — cheap + reliable
    update_model: str = "claude-haiku-4-5-20251001"  # Haiku on VPS (proxy routes to whatever model it has)
